...
export const PERMISSIONS = {
  ...
  PLATFORM_WALLETS_READ: "platform_wallets.read",
  PLATFORM_WALLETS_MANAGE: "platform_wallets.manage",
...
export const DEFAULT_ROLE_PERMISSIONS: Record<AdminRole, Permission[]> = {
  ...
  administrator: [
    ...
    PERMISSIONS.PLATFORM_WALLETS_READ,
    PERMISSIONS.PLATFORM_WALLETS_MANAGE,
