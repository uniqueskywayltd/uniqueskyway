    ...
    <div className="space-y-8">
      <AdminPageHeader
        ...
        actions={
          <>
            ...
            <Link href="/admin/operations" className={buttonVariants({ variant: "outline", size: "sm" })}>
              Operations Center
            </Link>
          </>
        }
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">
          ...
          <Link href="/admin/reports?tab=roi" className="mt-4 inline-block text-sm text-blue-400 hover:underline">
            View ROI history →
          </Link>
        </div>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Link href="/admin/audit" className="text-sm text-blue-400 hover:underline">
            Audit center →
          </Link>
        </div>
