    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          value={String(data.maturedInvestments)}
          icon={<TrendingUp />}
          href="/dashboard/portfolio"
        ...
        <StatCard
          ...
          value={String(data.pendingInvestments)}
          icon={<Clock />}
          href="/dashboard/portfolio"
        ...
        <StatCard
          ...
          value={formatMoney(data.totalPrincipal, data.currency)}
          icon={<PieChart />}
          href="/dashboard/ledger?entryType=investment_principal"
          actionLabel="Principal ledger"
          accent="primary"
        />
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <StatCard
          title="ROI earned (ledger)"
          value={formatMoney(data.totalRoiEarned, data.currency)}
          icon={<TrendingUp />}
          href="/dashboard/ledger?entryType=investment_interest"
          actionLabel="ROI ledger"
          accent="emerald"
        />
        <StatCard
          title="Accrued interest"
          value={formatMoney(data.totalAccruedInterest, data.currency)}
          icon={<Clock />}
          href="/dashboard/portfolio"
          actionLabel="View accruals"
          accent="sky"
        />
      </div>

      <AllocationChart data={data.allocation} href="/dashboard/portfolio" viewLabel="Explore allocation" />
