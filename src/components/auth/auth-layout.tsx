...
export function AuthLayout({
  ...
  return (
    <div className={cn("grid min-h-screen bg-background lg:grid-cols-[1.05fr_1fr]", className)}>
      {/* Brand panel */}
      <div className="relative hidden overflow-hidden border-r border-border/50 bg-muted/35 lg:block dark:bg-card/40">
        ...
        <div className="relative flex h-full flex-col justify-between p-12 xl:p-16">
          <Link href="/" className="inline-flex shrink-0">
            <BrandLogo variant="theme" width={150} priority />
          </Link>

          <div className="max-w-md">
            <div className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.16em] text-amber-900 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100">
      ...
      <div className="relative flex flex-col bg-background">
        <div className="relative flex flex-1 flex-col">
          <div className="flex items-center justify-between gap-3 border-b border-border/50 px-6 py-5 lg:px-10">
            <Link href="/" className="inline-flex shrink-0 lg:hidden">
              <BrandLogo variant="theme" width={120} priority />
            </Link>
